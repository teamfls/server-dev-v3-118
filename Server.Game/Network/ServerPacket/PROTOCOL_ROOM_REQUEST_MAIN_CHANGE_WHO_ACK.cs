...
namespace Server.Game.Network.ServerPacket
{
    public class PROTOCOL_ROOM_REQUEST_MAIN_CHANGE_WHO_ACK : GameServerPacket
    {
        ...
        public PROTOCOL_ROOM_REQUEST_MAIN_CHANGE_WHO_ACK(uint A_1) => this.Field0 = A_1;

        public PROTOCOL_ROOM_REQUEST_MAIN_CHANGE_WHO_ACK(int A_1) => this.Field0 = (uint)A_1;
